...
# Calendar
DEFAULT_EVENTS_NUMBER = os.environ.get("DEFAULT_EVENTS_NUMBER", "<YOUR-PREFERRED-NUMBER-OF-EVENTS-TO-DISPLAY>")
PATH_TO_CRED = os.environ.get("PATH_TO_CALENDAR_API_CRED", "<PATH-TO-GOOGLE-CALENDAR-API-CRED-DOT-JSON-FILE>")
